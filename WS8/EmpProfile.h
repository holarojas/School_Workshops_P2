...
namespace sdds {
	...
	struct EmployeeWage {
		...
		//Function that reports an exception if the object's salary is more than 99,999 or less than 0.
		void rangeValidator()
		{
			if (m_salary > 99999.00 || m_salary < 0.0) {
				throw "EXCEPTION: Salary out of range.\n";
			}
		}
